...
const ComplaintRegister=async(req,res)=>{
    try {
        const {fullName,phoneNumber,email,location,description,date}=req.body;
   ...
   date:date,
    ...
    return res.status(200).json({ success: true, message: "Complaint Register successfully!"});
    } catch (error) {
        console.log(error);
...
module.exports={ComplaintRegister,ComplaintView};